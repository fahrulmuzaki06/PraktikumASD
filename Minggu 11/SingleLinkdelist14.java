public class SingleLinkdelist14 {
    ...
    public void addFirst(MahasiswaaA14 input){
    ...
    public void addLast(MahasiswaaA14 input){
        NodeMahasiswa14 ndInput = new NodeMahasiswa14(input, null);
        if (isEmpty()) {
            head = ndInput;
            tail = ndInput;
    ...
    public void insertAfter(String key, MahasiswaaA14 input){
        NodeMahasiswa14 ndInput = new NodeMahasiswa14(input, null);
    ...
    public void insertAt(int index, MahasiswaaA14 input){
        if (index < 0) {
